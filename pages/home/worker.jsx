  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="List Worker page contains list worker"
        />
      ...
      <div className="container my-5" style={{ maxWidth: "800px" }}>
        <form className="d-flex mx-auto" onSubmit={search}>
          <input
            ...
            value={searchQuery}
          />
          <select className="form-select me-2" onChange={(e) => setSortQuery(e.target.value)} style={{width: '100px'}}>
            <option value="">Sort</option>
            <option value="name">Sortir berdasarkan nama</option>
            <option value="createdAt">Sortir berdasarkan tanggal bergabung</option>
          </select>
